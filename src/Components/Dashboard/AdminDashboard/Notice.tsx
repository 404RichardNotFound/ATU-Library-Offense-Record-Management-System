    ...
    <div className="bg-white rounded-md p-3 h-full border-2">
      ...
      <div className="flex flex-col gap-4 w-full">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="mt-4 bg-blue-500 flex items-center justify-center gap-2 cursor-pointer w-32 font-semibold hover:bg-blue-600 text-white p-1.5 rounded-md disabled:opacity-50"
            disabled={loading}
          >
